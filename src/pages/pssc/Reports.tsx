...
const Reports: React.FC = () => {
    ...
    return (
        <DashboardLayout
            ...
            description="View and export provincial OHS compliance and incident reports"
            ...
            <div className="bg-white rounded-2xl shadow-sm border border-gray-100 overflow-hidden">
                <div className="p-5 border-b border-gray-100 flex items-center justify-between">
                    <div>
                        ...
                        <p className="text-xs text-gray-500">Provincial incident breakdown and compliance logs</p>
                    </div>
                </div>
                    ...
                    <table className="w-full text-left border-collapse">
                        <thead>
                            <tr className="bg-gray-50/50 border-b border-gray-100 text-[11px] font-bold uppercase tracking-wider text-gray-400">
                                ...
                                <th className="px-5 py-3.5">Incidents</th>
                        ...
                        <tbody className="divide-y divide-gray-100 text-sm">
                            {isLoading ? (
                                <tr>
                                    <td colSpan={8} className="px-5 py-8 text-center text-gray-400 font-semibold text-xs">
                                        Loading reports...
                                    </td>
                                </tr>
