...
import { Eye, Calendar, User, Search, RefreshCw, Folder } from 'lucide-react';

const HRLoggedIncidents: React.FC = () => {
    ...
    const fetchCases = async () => {
        ...
        try {
            ...
            console.error(err);
            setError('Failed to fetch logged incidents.');
        } finally {
            setLoading(false);
        }
    };
    ...
    const getHrStatusBadge = (status?: string) => {
        ...
        switch (s) {
            case 'HR_UNASSIGNED':
                return <span className="px-2.5 py-1 rounded-full text-xs font-semibold bg-gray-100 text-gray-500 border border-gray-200">Unassigned</span>;
            case 'HR_ASSIGNED':
    ...
    return (
        <DashboardLayout
            ...
            description="View and track the status of all Workmen's Compensation claims."
            breadcrumbs={[{ label: 'HR Benefits', path: '/hr/dashboard' }, { label: 'Logged Incidents' }]}
        >
            <div className="space-y-6">
                ...
                <div className="flex flex-wrap items-center justify-between gap-4">
                    <div className="relative w-full max-w-md">
                        ...
                        <input
                            type="text"
                            placeholder="Search by Ref #, employee name, or description..."
                            value={searchQuery}
...
export default HRLoggedIncidents;
