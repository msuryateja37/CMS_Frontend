...
const OHSSubmitCase: React.FC = () => {
    ...
    const handleSubmit = async () => {
        try {
            ...
            alert('OHS incident reported successfully!');
    ...
    return (
        <DashboardLayout title="Report OHS Incident" description="Report Incident" breadcrumbs={[{ label: "Dashboard", path: "/ohs/dashboard" }, { label: "Report Incident" }]}>
                        ...
                        <StepIncidentType
                            ...
                            onSelect={(categoryId, type) => {
                                ...
                                if (formData.categoryId && formData.categoryId !== categoryId) {
                                    setFormData({
                                        id: generateId(), // Keep the ID or generate a new one on reset? Usually new categorization means new draft.
                                        type: type,
                                        categoryId,
