    ...
    const Checkbox = ({ checked, onChange }: { checked: boolean; onChange: (e: any) => void }) => (
        <div className="relative flex items-center justify-center">
            <input
                ...
                checked={checked}
                onChange={onChange}
                className="peer appearance-none w-5 h-5 rounded border border-gray-300 bg-white checked:bg-gold checked:border-gold cursor-pointer transition-all"
            />
            <svg
        ...
        <div className="bg-white rounded-2xl shadow-sm border border-semi-subtle-grey overflow-hidden mb-5">
            ...
            {(title || searchable || filterable) && (
                <div className="py-4 px-5 flex flex-col md:flex-row items-center justify-between border-b border-semi-subtle-grey gap-3">
                    {title && <h3 className="text-base font-bold text-brown">{title}</h3>}
                        ...
                        {searchable && (
                            <div className="relative flex-1 md:flex-none md:w-64">
                                ...
                                <input
                                    ...
                                    className="w-full pl-9 pr-4 py-2 bg-subtle-grey border-none rounded-lg text-sm focus:outline-none focus:ring-1 focus:ring-gold"
                                />
                            </div>
                        )}
                                ...
                                return (
                                    <th
                                        ...
                                        className={clsx(
                                            ...
                                            col.sortable && "cursor-pointer hover:text-brown transition-colors",
                                            col.accessorKey && effectiveSortBy === col.accessorKey && "text-brown",
                                            col.className,
                                                ...
                                                <div className="flex flex-col -gap-1">
                                                    <ChevronDown
                                                        ...
                                                        className={clsx(
                                                            ...
                                                            col.accessorKey && effectiveSortBy === col.accessorKey && effectiveSortOrder === 'asc' ? "text-gold" : "text-light-grey/30"
                                                        )}
                                                    />
                                                    <ChevronDown
                                                        size={10}
                                                        className={clsx(
                                                            "transition-colors",
                                                            col.accessorKey && effectiveSortBy === col.accessorKey && effectiveSortOrder === 'desc' ? "text-gold" : "text-light-grey/30"
                                                        )}
                                                    />
                                                </div>
                                            )}
