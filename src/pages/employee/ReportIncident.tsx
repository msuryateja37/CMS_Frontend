...
const ReportIncident: React.FC = () => {
    ...
    const handleSubmit = async () => {
        try {
            ...
            // Create case via hook
            const newCase = await createCaseMutation.mutateAsync(caseData);
            ...
            // Error is handled by TanStack Query if we want, but local alert is fine for now
